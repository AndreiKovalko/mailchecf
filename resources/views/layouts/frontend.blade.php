...
<body class="navbar-top full-display color-scheme-{{ Auth::user()->customer->getColorScheme() }} {{ session()->get('color') }}">
    ...
    <div class="navbar navbar-{{ Auth::user()->customer->getColorScheme() == "white" ? "default" : "inverse" }} navbar-fixed-top">
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav" style="display: none">
                ...
                <li rel0="MailListController" rel1="FieldController" rel2="SubscriberController" rel3="SegmentController">
                ...
                <li class="dropdown language-switch" rel0="SendingServerController" rel1="SendingDomainController" rel2="SenderController" rel3="EmailVerificationServerController" rel4="BlacklistController">
                    <a class="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right app-icons">
                        <li><a href="https://builderchef.app" target="_blank"><img src="{{ asset('images/imgpsh_fullsize_anim.png') }}" alt="{{ __('') }}"></a></li>
                        <li><a href="https://urlchef.app"  target="_blank"><img src="{{ asset('images/urlchef.png') }}" alt="{{ __('') }}"></a></li>
                    </ul>
                </li>
    ...
    <div class="page-sidebar" id="main-menu-small">
        <div class="page-sidebar-wrapper" id="main-menu-wrapper">
            <ul class="nav navbar-nav">
                ...
                <li rel0="MailListController" rel1="FieldController" rel2="SubscriberController" rel3="SegmentController">
                    <a href="{{ action('MailListController@index') }}"><i class="icon-address-book2"></i></a>
                </li>
                <li rel0="TemplateController">
                    <a href="{{ action('TemplateController@index') }}">
