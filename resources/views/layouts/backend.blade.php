...
<body class="navbar-top  full-display color-scheme-{{ Auth::user()->admin->getColorScheme() }} {{ session()->get('color') }}">
    ...
    <div class="navbar navbar-{{ Auth::user()->admin->getColorScheme() == "white" ? "default" : "inverse" }} navbar-fixed-top">
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav" style="display: none">
                ...
                <li class="dropdown language-switch" rel0="CustomerGroupController" rel1="CustomerController">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                ...
                <li class="dropdown language-switch" rel0="PlanController" rel1="CurrencyGroupController">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                ...
                <li class="dropdown language-switch" rel0="AdminGroupController" rel1="AdminController">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                ...
                <li class="dropdown language-switch" rel0="BounceHandlerController" rel1="FeedbackLoopHandlerController" rel2="SendingServerController" rel3="SendingDomainController" rel3="SubAccountController">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                ...
                @endif
                <li class="dropdown language-switch" rel0="TemplateController" rel1="LayoutController" rel2="LanguageController" rel3="SettingController">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                ...
                <li class="dropdown language-switch" rel0="TrackingLogController" rel1="OpenLogController" rel2="ClickLogController" rel3="FeedbackLogController" rel4="BlacklistController" rel5="UnsubscribeLogController" rel6="BounceLogController">
                    <a class="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li><a href="{{ url('togglecolor') }}"><i class="icon-lamp"></i> @if(session()->get('color')){{ trans('WhiteMode') }}@else{{ trans('Darkmode') }}@endif</a></li>
                        <li><a href="{{ url("/logout") }}"><i class="icon-switch2"></i> {{ trans('messages.logout') }}</a></li>
                    </ul>
                </li>
            </ul>
    ...
    <!-- /side bar -->
    <!-- samll side bar -->
    <div class="page-sidebar" id="main-menu-small">
        <div class="page-sidebar-wrapper" id="main-menu-wrapper">
            <ul class="nav navbar-nav">
                <li rel0="HomeController">
                    <a href="{{ action('Admin\HomeController@index') }}">
    ...
    <script>
        $('#layout-toggle').click(function() {
            if ($('body').hasClass('mobile-enable')) {
                $('body').removeClass('mobile-enable');
                $('body').addClass('full-display');
            } else {
                $('body').removeClass('full-display');
